...
class teacherController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teacher.teacher', compact('data'));
    }
...
//        }
        if ($request->hasFile('image')) {
            ...
            $file->move('public/teacher',$fileName);
            $input['image']=$fileName;
        }

        $data=teacherModel::create($input);
        return redirect('/teacher')->with('success','Your data is added');
    }
    ...
    public function destroy($id)
    {
        $data=teacherModel::findOrFail($id);
        $data->delete($data);
        return redirect('/teacher')->with('error','Your data is deleted');
