...
<div class="container" style="width: 100%; margin: auto;">
    ...
    <div class="wrapper" style="background-color:white;">
        {!! Form::open(array('route'=> ['teacher.update', $info->id], 'method'=>'PUT', 'class'=>'form-horizontal', 'files'=>true)) !!}

        <div class="row col-md-12 {{ $errors->has('e_name') ? 'has-error' : '' }} ">
            {{ Form::label('e_name', ' Name (English) :', array('class'=>'control-label col-md-2'))}}
            {{ Form::text('e_name', $info->e_name, array('class'=>'col-md-10 form-control', 'placeholder'=>' Name English'))}}
        ...
        <div class="row col-md-12 {{ $errors->has('b_name') ? 'has-error' : '' }} ">
            ...
            {{ Form::text('b_name',  $info->b_name, array('class'=>'col-md-10 form-control', 'placeholder'=>' Name Bangla'))}}
        ...
        <div class="row col-md-12 {{ $errors->has('S') ? 'has-error' : '' }} ">
            ...
            {{ Form::select('gender', ['null'=>' Gender','Male'=>'Male', 'Female'=>'Female'],$info->gender, array('class'=>'col-md-4 form-control select_btn' ),array('class'=>' form-control  col-md-4' ), array('style'=>'width:360px;' ))}}
          ...
          <strong>{{ $errors->first('gender') }}</strong>
            ...
            {{ Form::select('blood', ['null'=>'Select blood', 'A+'=>'A+','B+'=>'B+','O+'=>'O+','O-'=>'O-','Ab+'=>'Ab+'],$info->blood, array('class'=>'col-md-4 form-control select_btn' ),array('class'=>' form-control  col-md-4' ),array('style'=>'width:360px;' ))}}
            @if($errors->has('blood'))
                <span class="help-block" style="display:block">
        ...
        <div class="row col-md-12 {{ $errors->has('dmy') ? 'has-error' : '' }} ">
            ...
            {{ Form::date('dmy', $info->dmy, array('class'=>' form-control col-md-4 select_btn' ))}}
            @if($errors->has('dmy'))
                <span class="help-block" style="display:block">
          <strong>{{ $errors->first('dmy') }}</strong>
            ...
            {{ Form::select('religion', ['null'=>' Religion', 'Muslim'=>'Muslim','Hindu'=>'Hindu','Boddo'=>'Boddo','Chistan'=>'Chistan'],$info->religion,array('class'=>' col-md-4 form-control select_btn' ),  array('class'=>' form-control  col-md-4' ),array('style'=>'width:360px;' ))}}
        ...
        <div class="row col-md-12 {{ $errors->has('t_id') ? 'has-error' : '' }} ">
            ...
            {{ Form::number('t_id', $info->t_id, array('class'=>' form-control col-md-4 select_btn' ))}}
            @if($errors->has('t_id'))
                <span class="help-block" style="display:block">
          <strong>{{ $errors->first('t_id') }}</strong>
            ...
            {{ Form::email('email', $info->email, array('class'=>' form-control col-md-4 select_btn' ))}}
            @if($errors->has('email'))
                <span class="help-block" style="display:block">
          <strong>{{ $errors->first('religion') }}</strong>
                   </span>
        ...
        <div class="row col-md-12 {{ $errors->has('phone') ? 'has-error' : '' }} ">
            ...
            {{ Form::number('phone',  $info->phone, array('class'=>'col-md-4 form-control', 'placeholder'=>' Mobaile no'))}}
            @if($errors->has('phone'))
                <span class="help-block" style="display:block">
          <strong>{{ $errors->first('phone') }}</strong>
            ...
            {{ Form::number('nid', $info->nid, array('class'=>'col-md-4 form-control', 'placeholder'=>' NID NO'))}}
            @if($errors->has('nid'))
                <span class="help-block" style="display:block">
    ...
    <div class="row col-md-12 {{ $errors->has('present_address') ? 'has-error' : '' }} ">
        ...
        {{ Form::textarea('present_address', $info->present_address, array('class'=>'col-md-4 form-control', 'placeholder'=>' address'))}}
        ...
        {{ Form::textarea('parmanent_address', $info->parmanent_address, array('class'=>'col-md-4 form-control', 'placeholder'=>' address'))}}
