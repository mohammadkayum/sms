...
<div class="container" style="width: 100%; margin: auto;">
    <h3 style="text-align: center;margin-top: 20px; margin-bottom: 30px">Admission  Here </h3>
    <div class="wrapper" style="background-color:white;">
        ...
        <div class="row col-md-12 {{ $errors->has('class') ? 'has-error' : '' }} ">
            ...
            {{ Form::select('class', ['null'=>' class','six'=>'six', 'seven'=>'seven','Eight'=>'Eight'], array('class'=>'col-md-3 select_btn' ), array('class'=>' form-control  col-md-4' ),array('style'=>'width:360px;' ))}}
            @if($errors->has('class'))
                <span class="help-block" style="display:block">
          <strong>{{ $errors->first('class') }}</strong>
            ...
            {{ Form::select('year', ['null'=>' Select Year', '2018'=>'2018','2017'=>'2017','2016'=>'2016','2015'=>'2015'], array('class'=>'col-md-3 select_btn' ), array('class'=>' form-control  col-md-4' ),array('style'=>'width:360px;' ))}}
            @if($errors->has('year'))
                <span class="help-block" style="display:block">
        ...
        <div class="row col-md-12 {{ $errors->has('std_phone') ? 'has-error' : '' }} ">
            ...
            {{ Form::number('std_phone', '', array('class'=>'col-md-10 form-control', 'placeholder'=>' Mobaile no'))}}
        ...
        <div class="row col-md-12 {{ $errors->has('pre_school') ? 'has-error' : '' }} ">
            {{ Form::label('pre_school', ' Previous School Name:', array('class'=>'control-label col-md-2'))}}
            {{ Form::text('pre_school', '', array('class'=>'col-md-10 form-control', 'placeholder'=>' previous school name'))}}
        ...
        <div class="row col-md-12 {{ $errors->has('f_name') ? 'has-error' : '' }} ">
            ...
            {{ Form::text('f_name', '', array('class'=>'col-md-10 form-control', 'placeholder'=>' Father name'))}}
        ...
        <div class="row col-md-12 {{ $errors->has('m_name') ? 'has-error' : '' }} ">
            ...
            {{ Form::text('m_name', '', array('class'=>'col-md-10 form-control', 'placeholder'=>' Mother name'))}}
        ...
        <div class="row col-md-12 {{ $errors->has('f_occation') ? 'has-error' : '' }} ">
            ...
            {{ Form::text('f_occation', '', array('class'=>'col-md-10 form-control', 'placeholder'=>' Father Occation '))}}
        ...
        <div class="row col-md-12 {{ $errors->has('m_occation') ? 'has-error' : '' }} ">
            ...
            {{ Form::text('m_occation', '', array('class'=>'col-md-10 form-control', 'placeholder'=>' Mother Occation '))}}
        ...
        <div class="row col-md-12 {{ $errors->has('g_name') ? 'has-error' : '' }} ">
            ...
            {{ Form::text('g_name', '', array('class'=>'col-md-10 form-control', 'placeholder'=>' Gurdian Name'))}}
        ...
        <div class="row col-md-12 {{ $errors->has('g_nid') ? 'has-error' : '' }} ">
            ...
            {{ Form::number('g_nid', '', array('class'=>'col-md-10 form-control', 'placeholder'=>' Gardian NID NO'))}}
            @if($errors->has('g_nid'))
                <span class="help-block" style="display:block">
        ...
        <div class="{{ $errors->has('image') ? 'has-error' : '' }} row col-md-12 ">
            ...
            {{ Form::file('image', array('class'=>'col-md-4 form-control'))}}

            {{ Form::label('status', ' Status:', array('class'=>'control-label col-md-2'))}}
            {{ Form::text('status', '', array('class'=>'col-md-4 form-control', 'placeholder'=>' Status'))}}
